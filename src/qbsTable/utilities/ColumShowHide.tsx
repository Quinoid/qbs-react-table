    ...
    <div>
      ...
      {isOpen && (
        <div className="qbs-table-column-popup" ref={popupRef}>
          ...
          <div className="qbs-table-popup-item">
            <div className="qbs-table-column">
              <div className="qbs-table-container">
                <div className="qbs-table-checkbox qbs-table-custom-checkbox">
                  <input
                    type="checkbox"
                    className="qbs-table-checkbox-input"
                  ...
                  />
                  <label htmlFor="available_columns">
                    <svg
                      width="8"
                      height="6"
                      viewBox="0 0 8 6"
              ...
              <div className="qbs-table-container">
                <div className="qbs-table-checkbox qbs-table-custom-checkbox">
                  <input type="checkbox" className="qbs-table-checkbox-input" id="contact" />
                ...
                <div className="qbs-table-popup-value">Contact</div>
              </div>
              <div className="qbs-table-container">
                <div className="qbs-table-checkbox qbs-table-custom-checkbox">
                  <input type="checkbox" className="qbs-table-checkbox-input" id="contact_email" />
                ...
                <div className="qbs-table-popup-value">Contact Email</div>
              </div>
            </div>
          </div>
          <div className="qbs-table-divider"></div>
          <div className="qbs-table-popup-item">
            <a className="qbs-table-reset-link" href="#">
              Reset to default
            </a>
          </div>
        </div>
